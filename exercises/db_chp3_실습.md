...
1. 사용자 관리 (Users)
관리자는 새로운 사용자 정보를 삽입할 수 있다.
관리자는 전체 사용자 정보를 검색할 수 있다.
사용자는 자신의 회원 정보를 검색할 수 있다.
사용자는 자신의 이메일 정보를 변경할 수 있다.
관리자는 탈퇴한 사용자의 정보를 삭제할 수 있다.
2. 상품 관리 (Products)
관리자는 새로운 상품 정보를 삽입할 수 있다.
사용자는 전체 상품 정보를 검색할 수 있다.
사용자는 특정 상품 정보를 검색할 수 있다.
관리자는 상품 가격 정보를 변경할 수 있다.
관리자는 판매 종료된 상품 정보를 삭제할 수 있다.
3. 주문 관리 (Orders)
사용자는 상품 주문 정보를 삽입할 수 있다.
사용자는 자신의 주문 정보를 검색할 수 있다.
관리자는 전체 주문 정보를 검색할 수 있다.
사용자는 주문 취소 시 주문 정보를 삭제할 수 있다.
관리자는 주문 수량 정보를 변경할 수 있다.
